...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/50 to-slate-100 flex items-center justify-center p-4">
      <div className="absolute top-10 left-10 w-64 h-64 bg-indigo-400/10 rounded-full blur-3xl" />
      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white rounded-3xl shadow-2xl shadow-slate-200/50 p-8 border border-slate-100">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 mt-2">登录你的 LinguaWorld 账号</p>
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 px-4 py-3 bg-white border border-slate-200 rounded-xl text-slate-700 font-medium hover:bg-slate-50 transition-colors">
